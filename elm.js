...
var _user$project$Main$tabs = _elm_lang$core$Native_Platform.incomingPort(
	'tabs',
...
var _user$project$Main$tabScreenshot = _elm_lang$core$Native_Platform.incomingPort(
	'tabScreenshot',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (id) {
...
var _user$project$Main$saveModel = _elm_lang$core$Native_Platform.outgoingPort(
	...
	function (v) {
		return {
			tabGroups: _elm_lang$core$Native_List.toArray(v.tabGroups).map(
				function (v) {
					return {
						id: v.id,
						title: v.title,
						tabs: _elm_lang$core$Native_List.toArray(v.tabs).map(
							function (v) {
								return {
									id: v.id,
									title: v.title,
...
var _user$project$Main$getModel = _elm_lang$core$Native_Platform.outgoingPort(
	'getModel',
	function (v) {
		return null;
	});
var _user$project$Main$init = {
	...
	_1: _user$project$Main$getModel(
		{ctor: '_Tuple0'})
};
var _user$project$Main$savedModel = _elm_lang$core$Native_Platform.incomingPort(
	'savedModel',
	_elm_lang$core$Json_Decode$oneOf(
		{
			ctor: '::',
...
var _user$project$Main$tabGroup = _elm_lang$core$Native_Platform.incomingPort(
	'tabGroup',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (id) {
			...
			switch (_p7.ctor) {
				...
				default:
					return _elm_lang$core$Native_Utils.update(
						tabGroup,
						{
							position: _user$project$Main$getPosition(tabGroup),
							drag: _elm_lang$core$Maybe$Nothing
						});
			}
		}
	...
	function (msg, model) {
		...
		switch (_p11.ctor) {
			...
			case 'AddTabGroup':
				var newTabGroups = {
					ctor: '::',
					_0: _user$project$Main$blankTabGroup(
						_elm_lang$core$List$length(model.tabGroups)),
					_1: model.tabGroups
				};
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Main$AddTabGroup = {ctor: 'AddTabGroup'};
var _user$project$Main$addTabGroupButton = A2(
	_elm_lang$html$Html$button,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$AddTabGroup),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('New Tab Group'),
		_1: {ctor: '[]'}
	});
var _user$project$Main$DeleteTabGroup = function (a) {
	return {ctor: 'DeleteTabGroup', _0: a};
};
var _user$project$Main$viewTabGroupDeleteButton = function (tabGroup) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: A2(_user$project$Main_ops['=>'], 'float', 'right'),
						_1: {
							ctor: '::',
...
var _user$project$Main$ChangeGroupTitle = F2(
	function (a, b) {
		return {ctor: 'ChangeGroupTitle', _0: a, _1: b};
	});
var _user$project$Main$FinishGroupTitleEdit = function (a) {
	return {ctor: 'FinishGroupTitleEdit', _0: a};
};
var _user$project$Main$StartGroupTitleEdit = function (a) {
	return {ctor: 'StartGroupTitleEdit', _0: a};
};
var _user$project$Main$viewTabGroupTitle = function (tabGroup) {
	return tabGroup.changingTitle ? A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(tabGroup.title),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}) : A2(
...
var _user$project$Main$GotSavedModel = function (a) {
	return {ctor: 'GotSavedModel', _0: a};
};
var _user$project$Main$GotTabScreenshot = function (a) {
	return {ctor: 'GotTabScreenshot', _0: a};
};
var _user$project$Main$GotTabGroup = function (a) {
	return {ctor: 'GotTabGroup', _0: a};
};
var _user$project$Main$GotTabs = function (a) {
	return {ctor: 'GotTabs', _0: a};
};
...
var _user$project$Main$subscriptions = function (model) {
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Main$savedModel(_user$project$Main$GotSavedModel),
			_1: {
				ctor: '::',
				_0: _user$project$Main$tabGroup(_user$project$Main$GotTabGroup),
				_1: {
					ctor: '::',
					_0: _user$project$Main$tabs(_user$project$Main$GotTabs),
					_1: {
						ctor: '::',
...
var _user$project$Main$viewTabGroup = function (tabGroup) {
	...
	return A2(
			...
			_1: {
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							ctor: '::',
							_0: A2(_user$project$Main_ops['=>'], 'padding', '10px'),
							_1: {
								ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$Main$viewTabGroupDeleteButton(tabGroup),
			_1: {
				ctor: '::',
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$addTabGroupButton,
			_1: A2(_elm_lang$core$List$map, _user$project$Main$viewTabGroup, model.tabGroups)
		});
};
